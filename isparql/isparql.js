    ...
    var URIClick = function(anchor,click_type){
      var new_query;
    	...
    	params.nav_stack.push({ query:new_query,
    	                        ...
    	                        should_sponge:params.should_sponge,
      ...
      callback:function(data,headers,param)  // function called on result
      {
        ...
        else
        {
  		...
  		nav_stack:[{query:paramsObj.query,
  		            ...
  		            should_sponge:paramsObj.should_sponge,
    	  ...
    	  this.should_sponge = this.nav_stack[this.nav_index].should_sponge;
    	  this.service = this.nav_stack[this.nav_index].service;
  		}
  	};
